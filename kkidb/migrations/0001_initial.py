# Generated by Django 2.2.5 on 2019-09-04 13:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kkidb.Member')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('award', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kkidb.Award')),
                ('judgement', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='kkidb.Judgement')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kkidb.Permissions')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kkidb.Member')),
            ],
            options={
